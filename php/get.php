...
else 
{
    echo "successful" ;
     ...
     //   echo 'Connected to: ';
        ...
        $daily_row = mysqli_fetch_array($result1, MYSQLI_ASSOC);
        ...
        $cycle_row = mysqli_fetch_array($result2, MYSQLI_ASSOC);
        ...
        $week_row = mysqli_fetch_array($result3);
        ...
        $hour_row = mysqli_fetch_array($result4);
        ...
        $result5 = mysqli_query($query);
        $power_row = mysqli_fetch_array($result5, MYSQLI_ASSOC);
