...
function ProcessDataFromDatabase() {
    ...
    */
	...
	message =  '<p style="font-size:80%; font-family:Trebuchet MS; margin-top:3px; color:#FF6600" >Save Power Day Event Today!<br/>Reduce your energy usage </br>2pm-6pm on 3/26/14</p><p style="font-size:80%; font-family:Trebuchet MS; margin-top:10px">Questions For SCE: 1-800-655-4555</p>';
...
function UpdateWeeklyChart(id) {
	...
	$('#divYaxis').css({'color':'#FFFFFF', 'font-size':'30px', 'font-family':'rockwell', 'margin-top':diffHeight+15, 'margin-right':'20px', 'border-right-style':'solid', 'border-right-width':'1px', 'padding-right':'10px'});
	$('#yaxis').css({'width':yaxisWidth});
	for(var i=0; i<5; ++i){
		var id='val'+i;
		$('#'+id).css({'height':yaxisBlockHeight});
		$('#'+id).html('<p style="color:#FFFFFF;font-size:25px;font-family:rockwell">'+maxYaxisVal/4*i+'kwh</p>');
	}
...
<div id="mainFrame" class="withboarder" style="position:absolute;margin-top:23px;margin-left:30px">
	...
	<div id="ComparisonPic" style="margin-top:60px; position:absolute; left: 300px; top: 370px"><img src="./img/Picture1.png" width="240"; height="240"/></div>
